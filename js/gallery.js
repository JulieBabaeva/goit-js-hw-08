...
function onGalleryList(event) {
  ...
  // -----розмітка модалки через бібліотеку-------
  const basicLightBoxInstance = basicLightbox.create(`<div class="modal">
    <img src="${largeImageUrl}" alt="${imageAlt}" width="1112" height="640">
    </div>`);
  // -----запускаємо функцію з бібліотеки-------
  basicLightBoxInstance.show();
}
// -----коментарі для себе щоб на майбутнє бачити що і як я робила
